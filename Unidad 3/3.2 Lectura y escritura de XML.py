...
Está diseñado para ser legible tanto por humanos como por máquinas. XML usa etiquetas para definir elementos y atributos para proporcionar información adicional sobre esos elementos.
"""
